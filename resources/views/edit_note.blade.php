                ...
                <div class="row mt-3">
                    <div class="col">
                        ...
                        <div class="mb-3">
                            ...
                            {{--MUITA ATENÇÃO... neste input com o value como trata-se de uma edição ele por padrão se não houver erro vai gravar a ultima informação sendo assim fazemos um if 
                            se não houver ele pega o valor do banco, e se houver erro passa a messagem de erro na tela--}}
